        ...
        <div className="grid lg:grid-cols-5 justify-center items-center  h-screen w-screen font-main  ">
            <div className="flex items-center h-full w-screen lg:w-full lg:col-span-2 bg-gradient-to-tr bg-white from-[#f7b167] via-[#fa7dbd]/90 to-[#f7b167] dark:from-[#087ee1]/90 dark:via-[#98fcbd]/70 dark:to-[#087ee1]/90 lg:bg-none lg:bg-transparent">
                <div className="flex flex-col items-center w-full ">
                    <div className="flex flex-col gap-9  bg-base-light md:scale-[1.2] lg:scale-100 lg:bg-transparent lg:dark:bg-transparent dark:bg-base-dark   max-w-sm sm:max-w-md lg:max-w-lg w-full px-10 sm:px-20 py-10 rounded-3xl shadow-base-primary-light dark:shadow-base-primary-dark lg:shadow-none lg:dark:shadow-none">
                        ...
                        <form className="flex flex-col justify-center gap-5 items-center" onSubmit={(e) => ""}>
